...
outdir = 'Output\Redispatch_hourly';
indir = 'data_files\Redispatch_hourly\TXT_files';

% Load filenames
files_tariff = dir([dir1,'data_files\Redispatch_hourly\TXT_files\']);
...
batch_header = {'file_name_instance','gas_price_instance','zone_instance','year_instance',...
                'input_cap_instance','output_cap_instance',...
                'input_LSL_instance','output_LSL_instance',...
                'Input_start_cost_inst','Output_start_cost_inst',...
                'input_efficiency_inst','output_efficiency_inst',...
                'in_heat_rate_instance','out_heat_rate_instance',...
                'storage_cap_instance','reg_cost_instance',...
                'min_runtime_instance','op_period_instance',...
                'int_length_instance',...
