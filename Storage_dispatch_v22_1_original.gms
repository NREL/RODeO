...
$if not set elec_rate_instance     $set elec_rate_instance     BLANK_hourly
$if not set add_param_instance     $set add_param_instance     additional_parameters_hourly
$if not set ren_prof_instance      $set ren_prof_instance      renewable_profiles_WIND_hourly
...
$if not set outdir                 $set outdir                 RODeO\Output\Wind_farm_plus_storage
$if not set indir                  $set indir                  RODeO\data_files\Wind_farm_plus_storage\TXT_files
...
$if not set input_LSL_instance     $set input_LSL_instance     0.0
...
$if not set input_efficiency_inst  $set input_efficiency_inst  0.912870747
$if not set output_efficiency_inst $set output_efficiency_inst 0.912870747
...
$if not set storage_cap_instance   $set storage_cap_instance   1
...
$if not set op_length_instance     $set op_length_instance     8784
$if not set op_period_instance     $set op_period_instance     8784
...
$if not set file_name_instance     $set file_name_instance     "Wind+Storage_hourly"
...
$if not set Renewable_MW_instance  $set Renewable_MW_instance  1000
