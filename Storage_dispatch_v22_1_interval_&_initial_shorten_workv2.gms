...
$if not set Input_start_cost_inst  $set Input_start_cost_inst  0.1
...
$if not set file_name_instance     $set file_name_instance     "15min_TEST"
...
$if not set current_int_instance   $set current_int_instance   17618
$if not set next_int_instance      $set next_int_instance      17619
...
*$include Input_files\%indir%\%elec_rate_instance%.txt
*$include Input_files\%indir%\%add_param_instance%.txt
*$include Input_files\%indir%\%ren_prof_instance%.txt
...
if( (arbitrage_and_AS.modelstat=1 or arbitrage_and_AS.modelstat=2 or arbitrage_and_AS.modelstat=8),
         ...
         if (next_interval>1,
               put RT_out_file;
                       ...
                       loop(next_int, put  next_interval,input_power_MW.l(next_int) /;
                       );
         );
