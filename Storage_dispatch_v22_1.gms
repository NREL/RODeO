...
$if not set file_name_instance     $set file_name_instance     "LCFSwithOUTPUT"
...
Equations
         ...
         input_capacity_limit_eqn2(interval,devices)     equation that limits the upper limit for the input of the facility
