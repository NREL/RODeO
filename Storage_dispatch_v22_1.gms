...
$if not set H2_consumed_instance   $set H2_consumed_instance   H2_consumption_distributed_hourly
...
$if not set load_prof_instance     $set load_prof_instance     Additional_load_Load1_hourly
...
$if not set storage_cap_instance   $set storage_cap_instance   6
