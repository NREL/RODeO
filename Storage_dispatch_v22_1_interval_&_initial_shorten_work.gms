...
$if not set current_int_instance   $set current_int_instance   22040
$if not set next_int_instance      $set next_int_instance      22041
$if not set current_stor_intance   $set current_stor_intance   0.5
$if not set current_max_instance   $set current_max_instance   0.5
$if not set max_int_instance       $set max_int_instance       1000000000
