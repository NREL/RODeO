...
comp_power_LP(interval)
comp_power_MP(interval)
comp_power_HP(interval)

transfer_LP_to_MP(interval)
transfer_MP_to_HP(interval)

* Use power and efficiency to set
storage_level_LP(interval,LPbanks)
storage_level_MP(interval,MPbanks)
storage_level_HP(interval,HPbanks)

pre_cooling_power(interval)
