...
sqlite_file = 'Default1.db'  # name of the sqlite database file
...
# Print Summary data
summary_data = np.zeros(shape=(61,len(files2load_summary))) 
for i0 in range(len(files2load_summary)):
    if (i0==1):
...
if 1==1:            # This section captures a subset of the output file 
    # Print Results data   
...
if 1==0:            # This section creates the entire output file 
    # Print Results data   
    c.execute('''CREATE TABLE Results ('Scenario' integer,
                                       'Interval' integer,
                                       'In Pwr (MW)' real,
